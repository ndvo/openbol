...
class player_pin(Scatter):
	"""This class represent the players in the field (which may also be called 'men' or 'pins'). There are ten of those, and their visual representation is part of this class."""
	...
	# Initialize the widget class
		super(player_pin, self).__init__()
	...
	def reload_image(self):
		...
		# If it has graphical representation, update it
			...
			self.image.source = source='./data/images/player-'+self.status_game+'-'+self.status_health+'.png'
