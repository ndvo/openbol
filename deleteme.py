...
class checkRoll(ModalView):
	def __init__(self, **kwargs):
		...
		self.main_screen = g.manager.current
		...
		self.str_friend = Label(text='10',font_size='40sp',font_name=self.mandingo_font, color=self.dark_brown, pos = (-75,194))
		self.str_foe = Label(text='8',font_size='40sp',font_name=self.mandingo_font, color=self.dark_brown, pos = (75,194))

		self.die1_friend = Image( source='./data/images/interface-die-2.png', pos=(-74,102) )
		self.die1_foe = Image( source='./data/images/interface-die-1.png', pos=(74,102) )
		self.die2_friend = Image( source='./data/images/interface-die-5.png', pos=(-74,38) )
		self.die2_foe = Image( source='./data/images/interface-die-3.png', pos=(74,38) )

		self.result_label_friend = Label(text='17',font_size='60sp',font_name=self.mandingo_font, color=self.dark_brown, pos = (-73,-56))
		self.result_label_foe = Label(text='12',font_size='60sp',font_name=self.mandingo_font, color=self.dark_brown, pos = (73,-56))

		self.sign_plus_friend = Image( source='./data/images/interface-sign-plus.png', pos=(-22,37) )
		self.sign_plus_foe = Image( source='./data/images/interface-sign-plus.png', pos=(134,37) )
		self.sign_equal_friend = Image( source='./data/images/interface-sign-equal.png', pos=(-75,-9) )
		self.sign_equal_foe = Image( source='./data/images/interface-sign-equal.png', pos=(78,-9) )

		self.label_result = Label(text='you get to attack',font_size='40sp',font_name=self.mandingo_font, color=self.brown, pos = (0,-122))
		self.label_click = Label(text='click to continue',font_size='20sp',font_name=self.mandingo_font, color=self.purple, pos = (0,-169))
	...
	def animation_pop(self, lapsed_time = 0.0):
		if self.pop_list != []:
			...
			if widget.__class__ == Label:
				pop = Animation(font_size = widget.final_font_size, duration = 1.8, transition = 'out_back')
			else:
				pop = Animation(size = widget.final_size, pos = widget.final_pos, duration = 1.8, transition = 'out_back')
			pop.start(widget)
